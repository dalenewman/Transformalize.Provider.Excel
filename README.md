...
This adds an `Excel` provider to Transformalize using [ExcelDataReader](https://github.com/ExcelDataReader/ExcelDataReader) for reading and [OpenXmlPowerTools](https://github.com/OfficeDev/Open-Xml-PowerTools) for writing.  It is a plug-in compatible with Transformalize 0.3.5-beta.
